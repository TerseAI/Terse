...
import { withDurableObjectEnvironment } from "../dist/durableObjectEnvironment.js"

const variableNames = ["DURABLE_OBJECT_TOKEN", "DURABLE_OBJECT_NAMESPACE_ID", "DURABLE_OBJECT_CONTROL_PLANE_URL"]
