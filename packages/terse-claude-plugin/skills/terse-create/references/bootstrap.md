# Bootstrap a Terse project (`terse init`)

Sets up a new SDK project pointed at Terse Cloud. Terse Cloud hosts the control plane and the data plane. When this finishes, return to the workflow-creation steps in SKILL.md.
