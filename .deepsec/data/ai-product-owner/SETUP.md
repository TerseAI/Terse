# Agent setup for `ai-product-owner`

This is a deepsec scanning workspace. Project `ai-product-owner` was just registered
(target: `..`). Setup is incomplete — `data/ai-product-owner/INFO.md`
...
2. **Fill in `data/ai-product-owner/INFO.md`.** It's auto-injected into the AI
...
```bash
pnpm deepsec scan    --project-id ai-product-owner
pnpm deepsec process --project-id ai-product-owner
```
