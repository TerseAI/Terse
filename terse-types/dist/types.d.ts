import { ConfigInstance, ConfigType } from "./Configs.js";
import { IntegrationType } from "./Integrations.js";
import { RunHistoryAction, RunHistoryActionType, RunHistoryRecordWithAgent } from "./RunHistoryTypes.js";
import { Project, Ticket } from "./TicketSystem.js";
...
export declare const TERSE_AGENT_MESSAGE_EVENT_TYPE: "terse_agent_message";
...
export declare enum FigmaEventTypes {
...
export type TemplateCategory = "ship" | "users" | "sync" | "track";
...
export type NotionReadablePropertyValue = string | number | boolean | null | string[] | NotionDateReference | NotionUserReference | NotionUserReference[] | NotionFileReference[] | Record<string, unknown>;
...
export type NotionModifyBlocksSuccess = (ToolOutputSuccessBase & {
    operation: "append";
    block_ids: string[];
    blocks_count: number;
...
export type ToolOutputByName = {
    ...
    notion_query_page: ToolOutputBase & NotionPageQueryMetadata & {
        properties: Record<string, NotionReadablePropertyValue>;
