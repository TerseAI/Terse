...
import type { MultipleChoiceOption } from "./Survey.js";
...
export type ToolCallGenerating = {
    tool_name: string;
    step_id: string;
    timestamp: number;
};
...
export declare enum ToolCallExecutionStatus {
    COMPLETED = "completed",
...
export declare enum SandboxStage {
...
export declare const SANDBOX_STAGE_LABELS: Record<SandboxStage, string>;
