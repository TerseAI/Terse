...
const vectraInterface_js_1 = require("./vectraInterface.js");
exports.default = (app) => {
    ...
    app.on("push", async (context) => {
        ...
        try {
            await vectraInterface_js_1.VectraInterface.githubPushEvent(context.payload.sender?.login, installationId, context.payload.repository.name, context.payload.ref, diffs);
        }
        catch (error) {
    ...
    app.on("installation.created", async (context) => {
        ...
        try {
            await vectraInterface_js_1.VectraInterface.githubAppInstallationCallback(name, email, login, installationId, repositoryName);
        }
        catch (error) {
    ...
    app.on("installation.deleted", async (context) => {
        ...
        const installationId = context.payload.installation.id;
        try {
            await vectraInterface_js_1.VectraInterface.githubAppInstallationDeleted(username, installationId);
        }
        catch (error) {
