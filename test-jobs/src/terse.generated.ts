...
export const ResendTemplates = {
    ...
    TerseCreditsSent: {
        ...
        variables: [
            { key: "ORG_NAME", type: "string", required: false, fallbackValue: "there" },
            { key: "CREDITS", type: "string", required: false, fallbackValue: "10,000" }
        ]
    }
...
export type ResendSendTemplateParams =
    ...
    | (ResendSendTemplateBaseParams & { templateId: typeof ResendTemplates.TerseFeedback.templateId; variables: Record<string, never> })
    | (ResendSendTemplateBaseParams & { templateId: typeof ResendTemplates.TerseWelcome.templateId; variables: Record<string, never> })
...
export const Skills = {
    ...
    resend(): TypedSkill<"resend_send_template"> {
...
You can optionally provide high-level context about what you're looking for in the PR, which will help the sub-agent focus its analysis. */
    ...
    resend: {
        ...
        sendTemplate(params: ResendSendTemplateParams): Promise<ToolOutputByName["resend_send_template"]>
    }
    slack: {
        /** Send message to a Slack channel or DM. Provide channelId (C…/G…/D…) or slackUserId (U…) to open or reuse a 1:1 DM. Supports plain text (mrkdwn) or Block Kit (JSON blocks). If both are set, channelId is used. */
            ...
            ? {
                  resend: {
                      sendTemplate: (params: ResendSendTemplateParams) =>
                          TerseAgent.executeTool<ToolOutputByName["resend_send_template"]>("resend_send_template", { ...params, integrationId: "cmrjspd6m0001y5fnew1q4he6" })
                  }
              }
            : {}),
        ...(allowed.has("slack")
