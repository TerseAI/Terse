...
export const BackendProvider: BackendService = {
  getCurrentUser: () => {
    return axios
      .get<User>(`${backendBaseUrl}/me`, { withCredentials: true })
      .then((response) => {
  ...
  getGithubLogInURL: () => {
    return axios
      .get<{ url: string }>(`${backendBaseUrl}/auth/github/login-url`, { withCredentials: true })
  ...
  getGoogleLogInURL: () => {
    return axios
      .get<{ url: string }>(`${backendBaseUrl}/auth/google/login-url`, { withCredentials: true })
      .then((response) => response.data)
      .catch((error) => {
  ...
  setSession: (token: string) => {
    return axios
      .post(`${backendBaseUrl}/auth/set-session`, { token }, { withCredentials: true })
      .then((response) => response.data)
      .catch((error) => {
  ...
  getUserById: (id: string) => {
    return axios
      .get<User>(`${backendBaseUrl}/users/${id}`, { withCredentials: true })
      .then((response) => response.data)
      .catch((error) => {
  ...
  createUser: (name: string, email: string, password: string) => {
    return axios
      .post(`${backendBaseUrl}/users`, { name, email, password }, { withCredentials: true })
      .then((response) => response.data)
      .catch((error) => {
  ...
  authenticateUser: (email: string, password: string) => {
    return axios
      .post(`${backendBaseUrl}/login`, { email, password }, { withCredentials: true })
      .then((response) => {
        return response.data;
      })
      .catch((error) => {
  ...
  terminateSession: () => {
    return axios
      .post(`${backendBaseUrl}/logout`, {}, { withCredentials: true })
      .then((_) => {})
      .catch((error) => {
  ...
  getDailyActivitySummary: () => {
    return axios
      .get(`${backendBaseUrl}/activity/daily-summary`, { withCredentials: true })
      .then((response) => response.data)
      .catch((error) => {
  ...
  getIntegrationsStatus: () => {
    return axios
      .get(`${backendBaseUrl}/integrations/status`, { withCredentials: true })
      .then((response) => response.data)
      .catch((error) => {
  ...
  getCurrentGithubIntegration: () => {
    return axios
      .get(`${backendBaseUrl}/github/get-current-integration`, { withCredentials: true })
      .then((response) => response.data)
      .catch((error) => {
  ...
  requestGitHubAppInstallationUrl: () => {
    return axios
      .get(`${backendBaseUrl}/github/installation-url`, { withCredentials: true })
      .then((response) => response.data)
      .catch((error) => {
  ...
  getCurrentSlackIntegration: () => {
    return axios
      .get(`${backendBaseUrl}/slack/get-current-integration`, { withCredentials: true })
      .then((response) => response.data)
      .catch((error) => {
  ...
  requestSlackOAuthUrl: () => {
    return axios
      .get(`${backendBaseUrl}/slack/get-oauth-url`, { withCredentials: true })
      .then((response) => response.data)
      .catch((error) => {
  ...
  getLinearApiKey: () => {
    return axios
      .get(`${backendBaseUrl}/linear/get-api-key`, { withCredentials: true })
      .then((response) => response.data)
      .catch((error) => {
  ...
  setLinearApiKey: (apiKey: string) => {
    return axios
      .post(`${backendBaseUrl}/linear/set-api-key`, { apiKey }, { withCredentials: true })
      .then((response) => response.data)
      .catch((error) => {
  ...
  deleteLinearApiKey: () => {
    return axios
      .delete(`${backendBaseUrl}/linear/delete-credentials`, { withCredentials: true })
      .then((response) => response.data)
      .catch((error) => {
  ...
  getJiraApiKey: () => {
    return axios
      .get(`${backendBaseUrl}/jira/get-api-key`, { withCredentials: true })
      .then((response) => response.data)
      .catch((error) => {
  ...
  setJiraApiKey: (email: string, baseUrl: string, apiKey: string) => {
    return axios
      .post(
        `${backendBaseUrl}/jira/set-api-key`,
        { email, baseUrl, apiKey },
  ...
  deleteJiraApiKey: () => {
    return axios
      .delete(`${backendBaseUrl}/jira/delete-credentials`, { withCredentials: true })
      .then((response) => response.data)
      .catch((error) => {
  ...
  getGmailIntegration: () => {
    return axios
      .get(`${backendBaseUrl}/gmail/get-integration`, { withCredentials: true })
      .then((response) => response.data)
      .catch((error) => {
  ...
  requestGmailOAuthUrl: () => {
    return axios
      .get(`${backendBaseUrl}/gmail/get-oauth-url`, { withCredentials: true })
      .then((response) => response.data)
      .catch((error) => {
  ...
  getNotionIntegration: () => {
    return axios
      .get(`${backendBaseUrl}/notion/get-integration`, { withCredentials: true })
      .then((response) => response.data)
      .catch((error) => {
  ...
  setNotionIntegration: (integrationToken: string, databaseId: string) => {
    return axios
      .post(
        `${backendBaseUrl}/notion/set-integration`,
  ...
  deleteNotionIntegration: () => {
    return axios
      .delete(`${backendBaseUrl}/notion/delete-integration`, { withCredentials: true })
      .then((response) => response.data)
      .catch((error) => {
  ...
  requestSessionSocketToken: () => {
    return axios
      .get(`${backendBaseUrl}/session/token`, { withCredentials: true })
      .then((response) => response.data)
      .catch((error) => {
  ...
  connectToCompletionSocket: async ({
    onMessageReceived,
    onOpen,
    onClose,
    onError,
  ...
  getUserAutomation: () => {
    return axios
      .get<Automation | null>(`${backendBaseUrl}/automations`, { withCredentials: true })
      .then((response) => response.data)
      .catch((error) => {
