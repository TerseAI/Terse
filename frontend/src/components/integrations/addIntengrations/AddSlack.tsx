...
export function AddToSlack() {
    const { isPolling, startPolling } = useIntegrations();
    ...
    return (
        <button
            ...
            className="w-fit px-3 py-2 text-md font-medium text-[theme(text-primary)] bg-[theme(background-elevated)] rounded-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
            <div className="grid grid-cols-[auto_auto] items-center gap-2 p-2">
                <svg
