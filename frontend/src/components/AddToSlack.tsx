...
export function AddToSlack() {
    ...
    return (
        <IntegrationCard
            ...
            isLoading={isLoading}
            connectionInfo={teamName ? `Team: ${teamName}` : undefined}
            connectButton={connectButton}
            icon={
                <svg className="w-4 h-4 text-[#4A154B]" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M6 15a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm0 1a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm6-7a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm0 1a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm6 7a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm0 1a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                </svg>
            }
        />
    );
