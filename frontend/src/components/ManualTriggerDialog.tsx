...
export function ManualTriggerDialog({ isOpen, onClose, inputId, onTriggered }: ManualTriggerDialogProps) {
        ...
        <Dialog open={isOpen} onOpenChange={open => !open && handleClose()}>
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>Run this automation now instead of waiting for the next scheduled time.</DialogDescription>
                </DialogHeader>
