...
export function LinearTeamSelector({
    ...
    if (teams.length === 0) {
        return (
            <div className="text-sm text-muted-foreground">
                No Linear teams found. Make sure your Linear integration has access to teams.
            </div>
        );
    }
...
function LinearTeamCombobox({
    teams,
    selectedTeamId,
    onSelect
}: LinearTeamComboboxProps) {
