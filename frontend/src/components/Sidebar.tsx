  ...
  return (
    <div className="flex flex-col h-full p-2">
      ...
      <SidebarItem to="/app" isActive={location.pathname === "/app"}>
        <LinkLabel
          title="Home"
          icon={<HomeIcon className="w-5 h-5 text-[theme(--color-accent)]" />}
        />
      </SidebarItem>
      ...
      <SidebarItem to="/app/integrations" isActive={location.pathname === "/app/integrations"}>
        <LinkLabel
          title="Integrations"
          icon={<Squares2X2Icon className="w-5 h-5 text-[theme(--color-accent)]" />}
        />
      </SidebarItem>
      {import.meta.env.VITE_FEATURE_AUTOMATIONS === "true" && (
        <SidebarItem to="/app/automations" isActive={location.pathname === "/app/automations"}>
          <LinkLabel
            title="Automations"
            icon={<Cog6ToothIcon className="w-5 h-5 text-[theme(--color-accent)]" />}
          />
        </SidebarItem>
      )}
  ...
  return (
    <Link
      ...
      className={`p-2 rounded-md transition-colors ${
        isActive ? "bg-[theme(background-surface)]" : "hover:bg-[theme(background-surface)]"
      }`}
    >
      {children}
    </Link>
