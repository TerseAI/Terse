            ...
            {hasConfiguration ? (
                <div className="flex flex-col gap-2 p-3 rounded-lg border border-[theme(border)] bg-[theme(background-light)]">
                    ...
                    <div className="flex items-center gap-2">
                        <a
                            href={buildFigmaFileUrl(selectedFileKey)}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-sm text-[theme(--color-accent)] hover:underline flex items-center gap-1"
                        >
                            View in Figma
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-xs text-[theme(text-secondary)] text-center">
                        Click to configure your Figma file and team ID
                    </p>
                </div>
            )}
