        ...
        <Popover open={open} onOpenChange={onOpenChange}>
            <PopoverTrigger asChild>
                <Button variant="outline">
                    ...
                    {selectedStatuses.size === 5 ? "All Status" : selectedStatuses.size === 0 ? "No Status" : `${selectedStatuses.size} Status`}
            ...
            <PopoverContent className="w-56" align="end">
                <div className="space-y-3">
                    <div className="flex items-center gap-3 cursor-pointer" onClick={() => onToggleStatus("success")}>
                        <Checkbox checked={selectedStatuses.has("success")} onCheckedChange={() => onToggleStatus("success")} />
                        <CheckCircle2 className="w-4 h-4 text-green-600 dark:text-green-400" />
                        <span className="text-sm">Success</span>
                    </div>
                    <div className="flex items-center gap-3 cursor-pointer" onClick={() => onToggleStatus("failed")}>
                        <Checkbox checked={selectedStatuses.has("failed")} onCheckedChange={() => onToggleStatus("failed")} />
                        <XCircle className="w-4 h-4 text-destructive" />
                        <span className="text-sm">Failed</span>
                    </div>
                    <div className="flex items-center gap-3 cursor-pointer" onClick={() => onToggleStatus("in_progress")}>
                        <Checkbox checked={selectedStatuses.has("in_progress")} onCheckedChange={() => onToggleStatus("in_progress")} />
                    ...
                    <div className="flex items-center gap-3 cursor-pointer" onClick={() => onToggleStatus("skipped")}>
                        <Checkbox checked={selectedStatuses.has("skipped")} onCheckedChange={() => onToggleStatus("skipped")} />
                    ...
                    <div className="flex items-center gap-3 cursor-pointer" onClick={() => onToggleStatus("awaiting_approval")}>
                        <Checkbox checked={selectedStatuses.has("awaiting_approval")} onCheckedChange={() => onToggleStatus("awaiting_approval")} />
