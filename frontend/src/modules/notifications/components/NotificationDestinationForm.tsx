...
import { IntegrationType, SlackIntegration } from "terse-types"
import { notificationDestinationsKey } from "terse-types"
import { CreateNotificationDestinationRequest, NotificationDestination, NotificationDestinationType, SlackNotificationDestination } from "terse-types"
import { SlackChannel } from "terse-types"
...
import { useSlackChannels } from "@/modules/integrations/api/useSlackChannels"
import { useSlackIntegrations } from "@/modules/integrations/api/useSlackIntegrations"
import { useSlackUsers } from "@/modules/integrations/api/useSlackUsers"
import { formatMPIMChannelName } from "@/modules/integrations/components/SlackChannelSelector"
import { SlackConnectionOptions } from "@/modules/integrations/components/helpers/SlackConnectionOptions"
...
export function NotificationDestinationForm({ existingDestination, onSuccess, onCancel }: NotificationDestinationFormProps) {
    ...
    return (
        <div className="space-y-4">
            ...
            {validationError && <div className="rounded-md border border-destructive/40 bg-destructive/10 px-3 py-2 text-sm text-danger">{validationError}</div>}
