      ...
      <div className="border-t border-[theme(border)] bg-[theme(background)] px-6 py-4">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <div className="text-xs text-[theme(text-secondary)]">
            <span className="font-medium text-[theme(text-primary)]">Pro tip:</span> Automations run
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-xs text-[theme(text-secondary)] mt-0.5">
            Describe what you want the AI to do with the incoming events
          </p>
        </div>
      </div>
      <TextareaAutosize
    ...
    <div className="flex justify-center relative -mb-6">
      <svg width="40" height="64" viewBox="0 0 40 64" className="overflow-visible">
        ...
        <circle r="1.5" fill="var(--color-accent)" opacity="0.8">
          <animateMotion dur="2s" repeatCount="indefinite" path="M 20 4 L 20 56" />
          <animate attributeName="opacity" values="0;0.8;0.8;0" dur="2s" repeatCount="indefinite" />
        </circle>

        <circle r="1.5" fill="var(--color-accent)" opacity="0.8">
          <animateMotion dur="2s" repeatCount="indefinite" path="M 20 4 L 20 56" begin="0.5s" />
          <animate
        ...
        <circle r="1.5" fill="var(--color-accent)" opacity="0.8">
          <animateMotion dur="2s" repeatCount="indefinite" path="M 20 4 L 20 56" begin="1s" />
          <animate
            attributeName="opacity"
            values="0;0.8;0.8;0"
            dur="2s"
        ...
        <circle r="1.5" fill="var(--color-accent)" opacity="0.8">
          <animateMotion dur="2s" repeatCount="indefinite" path="M 20 4 L 20 56" begin="1.5s" />
          <animate
            attributeName="opacity"
            values="0;0.8;0.8;0"
            dur="2s"
