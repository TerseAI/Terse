          ...
          <>
            <DisclosureButton className="w-full">
              <div className="flex justify-between items-center">
                <h4 className="font-medium text-sm text-[theme(text-primary)]">{event.title}</h4>
  ...
  return (
    <div className="space-y-2">
      {commits.map((commit, index) => (
        <div
          key={index}
          className="flex items-start space-x-2 p-2 bg-[theme(background-secondary)] rounded-md"
        >
