            ...
            {hasMore && (
                <div className="flex justify-center pt-2">
                    <button
                        ...
                        className="px-6 py-2 bg-[theme(background-light)] text-[theme(text-primary)] rounded-lg hover:bg-[theme(background)] transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
                    >
