    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="px-6 py-20 bg-black/20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-6">How Vectra AI Works</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              We monitor your GitHub activity and use AI to create meaningful summaries of what your
              team is working on
            </p>
          </div>
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    We track all commits, pull requests, and issues in your repositories to
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    Our AI analyzes code changes and creates intelligent summaries that help you
                    understand the impact and context of each update.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    Get a real-time view of your team's progress with a clean, intuitive dashboard
                    that shows you exactly what's happening.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-16">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              <div className="lg:w-1/2">
                ...
                <p className="text-xl text-gray-300 mb-6 leading-relaxed">
                  Sign in with your GitHub account and select the repositories you want to monitor.
                  Vectra AI will start tracking activity immediately.
                </p>
            ...
            <div className="flex flex-col lg:flex-row-reverse items-center gap-12">
              <div className="lg:w-1/2">
                ...
                <p className="text-xl text-gray-300 mb-6 leading-relaxed">
                  Your team continues working normally in GitHub. Every commit, PR, and issue is
                  automatically detected and analyzed by our AI.
                </p>
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              <div className="lg:w-1/2">
                ...
                <p className="text-xl text-gray-300 mb-6 leading-relaxed">
                  View your beautiful activity dashboard with AI-generated summaries. Understand
                  what your team is building without digging through commits.
                </p>
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-green-400 rounded-full"></div>
      ...
      <div className="px-6 py-20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-white mb-4">Stop These Frustrations</h2>
            <p className="text-xl text-gray-300">Common problems that Vectra AI solves</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 rounded-2xl p-8 border border-gray-700/50 hover:border-gray-600/50 transition-all duration-300">
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                Stop asking "what are you working on?" and digging through commit logs. Get
                automatic insights into your team's activity without any manual work.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 rounded-2xl p-8 border border-gray-700/50 hover:border-gray-600/50 transition-all duration-300">
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                Get a single dashboard that shows you everything happening across your repositories.
                No need to check multiple tools or dig through individual commits.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="px-6 py-16 text-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold text-white mb-6">Ready to see your team's activity?</h2>
