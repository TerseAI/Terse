            ...
            <div className="px-6 py-20">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <button 
                        ...
                        className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-12 py-4 rounded-xl text-xl font-semibold shadow-2xl inline-flex items-center gap-3 hover:brightness-110 hover:scale-[1.02] transition-[filter,transform] duration-100 overflow-hidden"
                    >
                            ...
                            <div className="lg:w-1/2">
                                <div className="bg-gray-800/30 rounded-xl p-4 border border-gray-700/50">
                                    <img 
                                        ...
                                        className="w-full h-auto rounded-lg shadow-2xl overflow-hidden"
                                    />
                                </div>
                            </div>
                        </div>
