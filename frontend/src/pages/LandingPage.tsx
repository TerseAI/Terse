        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
            ...
            <div className="px-6 py-20">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <button 
                        onClick={loginWithGithub}
                        className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-12 py-4 rounded-xl text-xl font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-2xl inline-flex items-center gap-3"
                    >
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="text-center p-6">
                            ...
                            <p className="text-gray-400">Automatically syncs with your existing tools to provide accurate, up-to-date project status</p>
                        </div>
                        ...
                        <div className="text-center p-6">
                            ...
                            <p className="text-gray-400">Get intelligent insights about project progress, blockers, and team productivity</p>
                        </div>
                        ...
                        <div className="text-center p-6">
                            ...
                            <h3 className="text-xl font-semibold text-white mb-2">Accurate Reporting</h3>
                            <p className="text-gray-400">Generate reports that reflect the true state of your projects, not just ticket status</p>
                        </div>
                    </div>
                </div>
            </div>
