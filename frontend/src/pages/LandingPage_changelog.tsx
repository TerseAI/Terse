      ...
      <div className="relative z-10 px-8 py-32">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-2xl md:text-3xl text-gray-300 mb-16 max-w-4xl mx-auto leading-relaxed font-light">
            AI that tracks Github, Slack, Linear to give you a real-time view of what your team is
            building.
          </p>
          ...
          <div className="relative mb-20">
            <div className="flex justify-center items-center space-x-8 mb-8">
              {["GitHub", "Slack", "Linear"].map((tool, i) => (
                ...
                >
                  <div
                    className="w-24 h-24 bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl flex items-center justify-center text-white/60 font-light tracking-wide group-hover:bg-white/10 group-hover:border-white/20 transition-all duration-500 hover:scale-110"
          ...
          <div className="space-y-32">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-20">
              <div className="lg:w-1/2">
                ...
                <p className="text-2xl text-gray-300 mb-8 leading-relaxed font-light">
                  Connect your GitHub repositories. Vectra AI starts monitoring commits immediately
                  across all your projects.
                </p>
                <div className="space-y-4">
                  {[
                    "Link all your project repositories",
                    "Set up project names and teams",
            ...
            <div className="flex flex-col lg:flex-row-reverse items-center gap-20">
              <div className="lg:w-1/2">
                ...
                <p className="text-2xl text-gray-300 mb-8 leading-relaxed font-light">
                  Your developers keep working exactly as they do now. No new processes, no extra
                  work, no changes to their workflow.
                </p>
                <div className="space-y-4">
                  {[
                    "Code, commit, and push as usual",
                    "No additional tracking required",
                    "Vectra AI does all the monitoring",
                  ].map((item, i) => (
                    <div key={i} className="flex items-center gap-4">
                      <div
            ...
            <div className="flex flex-col lg:flex-row items-center gap-20">
              <div className="lg:w-1/2">
                ...
                <p className="text-2xl text-gray-300 mb-8 leading-relaxed font-light">
                  Check your dashboard anytime to see what's happening across all projects. Get
                  alerts when things need attention.
                </p>
                <div className="space-y-4">
                  {[
                    "Real-time project status updates",
                    "Team activity and progress tracking",
                    "Automatic alerts for blockers",
                  ].map((item, i) => (
                    <div key={i} className="flex items-center gap-4">
                      <div
      ...
      <div className="relative z-10 px-8 py-32">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            <p className="text-2xl text-gray-300 max-w-3xl mx-auto font-light">
              Automatic project visibility without the overhead. See what your team is building in
              real-time.
            </p>
          </div>
              ...
              {[
                {
                  ...
                  description:
                    "See progress across all your projects in one place. No more switching between tools or asking for updates.",
                },
                {
                  icon: "⚡",
                  title: "Real-Time Updates",
                  description:
                    "Every code commit automatically updates your project status. No manual tracking, no forgotten updates.",
                },
                {
                  icon: "✨",
                  title: "Zero Maintenance",
                  description:
                    "Works with your existing GitHub workflow. No new processes, no PM overhead, no team training required.",
                },
              ].map((feature, i) => (
      ...
      <div className="relative z-10 px-8 py-32">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            <p className="text-2xl text-gray-300 max-w-3xl mx-auto font-light">
              You're running multiple projects with a small team. Here's what's probably keeping you
              up at night:
            </p>
          </div>
