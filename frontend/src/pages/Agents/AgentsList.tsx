...
import { AgentsHeader, DeletingModal, SearchBar, StatusFilter } from "../../components/Agents"
            ...
            <div className="flex-1 overflow-y-auto">
                <div className="mx-auto space-y-6">
                    ...
                    <div className="grid grid-cols-20 sm:grid-flow-row gap-3">
                        ...
                        <StatusFilter statusOptions={statusOptions} selectedOption={selectedOption} onStatusChange={option => setStatusFilter(option.value)} className="col-span-4" />
                    </div>

                    <AgentsTable onEdit={handleEdit} onDelete={handleDelete} onCreateNew={handleCreateNew} searchQuery={searchQuery} statusFilter={statusFilter} />
                </div>
            </div>
