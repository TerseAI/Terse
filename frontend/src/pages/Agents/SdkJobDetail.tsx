...
import { Clock, Info, Lightbulb, Loader2, MoreVertical, Pause, Play, Server, Trash2, Zap } from "lucide-react"
...
export default function SdkJobDetail({ agentId }: { agentId: string }) {
    ...
    const hasSelfHostedJobUrl = agent.source === "SDK" && !!agent.prompt?.jobUrl
