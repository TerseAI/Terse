...
export function SVGFlowArrows({ containerRef, connections }: SVGFlowArrowsProps) {
...
function getEdgePoint(el: HTMLElement, container: HTMLElement, side: "left" | "right" | "top" | "bottom" | "center" = "center") {
