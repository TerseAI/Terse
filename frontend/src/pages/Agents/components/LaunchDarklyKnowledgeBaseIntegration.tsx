    ...
    if (integrations.length === 0 && !showConnectForm) {
        return (
            <div className="flex flex-col gap-3 p-4 rounded-lg border border-dashed border-input bg-card">
                <div className="text-sm text-muted-foreground">No LaunchDarkly integrations connected. Connect your LaunchDarkly account to get started.</div>
                            ...
                            <Tooltip>
                                ...
                                <TooltipContent>
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <a href="https://app.launchdarkly.com/settings/authorization" target="_blank" rel="noopener noreferrer" className="underline hover:no-underline">
                                            Open API keys page
                                        </a>
                                    </div>
                                </TooltipContent>
                ...
                <>
                    <div className="space-y-2">
                        ...
                        {isLoadingProjects ? (
                            ...
                            <Select value={projectKey} onValueChange={handleProjectKeyChange} disabled={isLoadingProjects}>
                                <SelectTrigger className="w-full">
                        ...
                        {!projectKey && !isLoadingProjects && <p className="text-sm text-muted-foreground">Please select a project to continue</p>}
                    </div>
