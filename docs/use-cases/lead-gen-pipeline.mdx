...
<Note>
    Some of the integrations, triggers, and SDK features below (WorkOS, Parallel Web Services, Parallel Monitor, structured agent output) are on the roadmap. The code samples reflect what the API will
    look like. Join the waitlist from **Integrations** in the app if you want early access.
</Note>
