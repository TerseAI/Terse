...
export const AttioIcon = (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 36.5 30">
        <path
            fill="currentColor"
...
export const WorkOSIcon = (
    <svg viewBox="0 0 256 222" fill="none">
        <path
...
<CardGroup cols={4}>
    ...
    <Card title="Google Search Console" icon="/images/integrations/google-search-console.svg" />
    ...
    <Card title="HeyReach" icon="/images/integrations/heyreach.png" />
