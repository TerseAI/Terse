---
title: "Overview"
description: "Terse is a code-first AI workflow platform for developers and coding agents."
icon: "house"
---
...
<CardGroup cols={2}>
    ...
    <Card title="Jobs" icon="workflow" href="/core-concepts/jobs">
        How `createJob` ties triggers, handlers, and `TerseAgent` together. The primitive every workflow is built on.
    </Card>
</CardGroup>
