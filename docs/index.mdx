---
title: "Overview"
description: "Terse is a code-first AI workflow platform that combines agent flexibility with deterministic reliability. Connect your tools, generate a typed SDK from your workspace, and deploy serverless workflows that call tools directly when you need precision and hand off to an agent when you need judgment."
icon: "house"
---
...
<CardGroup cols={4}>
    ...
    <Card title="Attio" icon="/images/integrations/attio.svg" />
