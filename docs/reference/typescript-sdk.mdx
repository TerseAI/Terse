...
- `sleep`, `jobStep`, `waitForInput`, `slack`: durable-only helpers for timed waits, custom steps, and human input prompts. See [Durable helpers](#durable-helpers)
...
Wraps custom side-effectful code as a durable step. See [Durability — Wrapping your own code with jobStep](/core-concepts/durability#wrapping-your-own-code-with-jobstep).
