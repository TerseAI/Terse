...
You can create multiple `Terse` instances in the same project. During `terse test`, `terse run`, and `terse deploy`, the CLI loads workflows from every constructed instance in your imported entry graph.
