...
This works across supported model providers, including OpenAI and Anthropic. The SDK also strips Zod-internal metadata before sending the schema, so provider-side schema parsing stays compatible.
