...
description: "Terse is the AI workflow platform for coding agents. Reference for the terse-sdk package and the generated helpers used in Terse workflows."
icon: "braces"
---

Terse is the AI workflow platform for coding agents. Workflows run in TypeScript, react to events from integrated services (GitHub, Slack, Linear, and more), and take actions using an AI-powered agent runner with access to those same services as tools.
