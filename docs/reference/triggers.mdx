...
| ------------------------- | ------------------------------- | -------------------------- |
| `GitHub.onPROpened()`     | `GitHubPullRequestTriggerEvent` | A pull request is opened   |
| `GitHub.onPush()`         | `GitHubPushTriggerEvent`        | Code is pushed to a branch |
| `GitHub.onIssueCreated()` | `GithubTriggerEvent`            | An issue is created        |
...
| Trigger             | Event type          | Description                      |
| ------------------- | ------------------- | -------------------------------- |
| `Slack.onMessage()` | `SlackTriggerEvent` | A message is posted in a channel |
| `Slack.onDm()`      | `SlackTriggerEvent` | A direct message is received     |
...
| Trigger                   | Event type     | Description                   |
| ------------------------- | -------------- | ----------------------------- |
| `Attio.onRecordCreated()` | `TriggerEvent` | A record is created in a list |
...
| Trigger            | Event type           | Description           |
| ------------------ | -------------------- | --------------------- |
| `WorkOS.onEvent()` | `WorkOSTriggerEvent` | A WorkOS event occurs |
...
| Trigger           | Event type         | Description              |
| ----------------- | ------------------ | ------------------------ |
| `Schedule.cron()` | `CronTriggerEvent` | Fires on a cron schedule |
...
<Expandable title="Event payload">- `body` - the raw JSON payload - `headers` - HTTP headers - `method` - HTTP method (GET, POST, etc.)</Expandable>

## Common event interface

All triggers resolve to the shared canonical `TriggerEvent` payload shape. Your handler receives the concrete subtype for the trigger you selected.
