...
| Tool                 | Description                                                                                                             | Access     |
| -------------------- | ----------------------------------------------------------------------------------------------------------------------- | ---------- |
| `attio_records`           | Record operations: `query`, `search`, `get`, `create`, `update`, `upsert`, `delete`, `get_attribute_history` | Read/Write |
| `attio_workspace_members` | Look up workspace members (`list`, `get`) to resolve record owners                                           | Read       |
| `attio_tasks`             | Tasks: `list`, `get`, `create`, `update`, `delete`                                                           | Read/Write |
| `attio_notes`             | Notes on records: `list`, `get`, `create`, `delete`                                                          | Read/Write |
| `attio_comments`          | Comments and threads: `create`, `get`, `delete`, `list_threads`, `get_thread`                                | Read/Write |
| `attio_lists`             | Lists and entries: CRUD plus `query_entries`, `add_entry`, `upsert_entry`, `update_entry`, `remove_entry`    | Read/Write |
| `attio_meetings`          | Meetings, call recordings and transcripts                                                                    | Read       |
| `attio_files`             | Files on records: `list`, `get`, `upload`, `get_download_url`, `delete`                                      | Read/Write |
| `attio_schema`            | Workspace schema: `list_objects`, objects/attributes/statuses/select-options read and write                  | Read/Write |
