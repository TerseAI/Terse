...
Open a new shell or source your shell config after installing for completion to take effect. Tab completion is opt-in only — run this command when you want to enable it.
