---
title: "CLI reference"
description: "The CLI for Terse, the AI workflow platform for coding agents."
icon: "terminal"
---

The `terse` CLI is the command-line interface for Terse, the AI workflow platform for coding agents. It has one scaffold command and a shared workflow CLI.
