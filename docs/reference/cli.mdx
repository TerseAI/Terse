...
Signing in completes once you have an API key; you are not asked to finish billing or payment setup in the terminal. Subscribe or manage payment methods anytime from **Billing** in the Terse web app.
