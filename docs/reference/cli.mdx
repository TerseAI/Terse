...
For form-based integrations, `connect` submits the provided field values immediately. For OAuth integrations, `connect` prints an authorization URL for you to open in a browser, then you finish the flow with `terse integrate wait`.
...
| Flag | Description |
| --- | --- |
| `--quiet` | Suppress the intro and outro banner |
