...
2. Fetches sample events from Terse for integration triggers such as GitHub, Slack, Attio, or Web Monitor
...
Sample events for integration-backed triggers use your Terse account and organization. Web Monitor samples can only be loaded when the monitor is configured in that same organization.
