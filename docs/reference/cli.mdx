...
The OAuth state token Terse mints for that handoff pins your authenticated Terse user and organization. Flow metadata cannot override those identity fields when the callback is verified.
