...
The CLI scaffolds, generates helpers for, and runs **TypeScript workflows on Node.js 20 or later** (22 recommended to match hosted workflows). There is no Python project layout or Python SDK for workflows.
