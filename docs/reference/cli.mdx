...
The CLI opens a session stream before deploy progress runs. If your API key is missing, expired, or invalid, the command exits with a clear **Not authenticated** message (instead of a raw HTTP error mid-deploy).
