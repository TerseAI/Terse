...
- New SDK workflow deploys seed default notification settings so **failed** runs can alert you; adjust channels and toggles in the workflow's notification settings in the app if needed
