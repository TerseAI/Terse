...
2. Opens your browser to a WorkOS verification page with Terse branding (tagline **AI Workflows as Code**, headline *Automation in your control.*, and supporting copy about workflows in the tools your team already uses)
