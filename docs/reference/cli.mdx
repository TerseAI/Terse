...
After `terse init` creates the project, it shows up in the app's project navigation immediately, even before your first `terse deploy`.
...
The linked project appears in the app's project navigation right away, even if it has zero deployed workflows.
