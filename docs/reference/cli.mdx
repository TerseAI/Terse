...
- Durable workflows (`durable: true`) use Terse's journal runtime directly and persist journals in project-scoped durable objects; there is no separate workflow bundle to compile.
