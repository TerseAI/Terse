...
description: "How Terse compiles your workspace context so workflows do not have to rediscover it at runtime."
icon: "lightbulb"
---
...
| Term              | Meaning                                                                                                        |
| ----------------- | -------------------------------------------------------------------------------------------------------------- |
| Workflow          | Am automation with triggers, skills, and a handler that you deploy with the CLI                      |
...
| Generated helpers | Typed exports in `src/terse.generated.ts`, including triggers, skills, resource constants, and `agent.tools.*` wrappers |
