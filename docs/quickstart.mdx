...
1. Scaffolds your project files (`src/index.ts` or `src/main.py`, config, etc.)
...
Open `src/index.ts` (or `src/main.py`) and define a job. The scaffolded file includes a starter example. Your generated SDK gives you typed helpers for every integration you connected: trigger builders, skill constructors, resource constants, and deterministic tool wrappers.
