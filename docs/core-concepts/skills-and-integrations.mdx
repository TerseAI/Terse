...
| Type      | Flow                                                        | Examples                                         |
| --------- | ----------------------------------------------------------- | ------------------------------------------------ |
| **OAuth** | Opens your browser for authorization                        | Attio, GitHub, Slack, Gmail, Linear, Notion, WorkOS |
| **Form**  | Prompts for API keys or account credentials in the terminal | Datadog, PostHog, Snowflake, LaunchDarkly          |
