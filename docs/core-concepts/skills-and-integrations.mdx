...
| Type      | Flow                                                        | Examples                                                                     |
| --------- | ----------------------------------------------------------- | ---------------------------------------------------------------------------- |
| **OAuth** | Opens your browser for authorization                        | GitHub, Slack, Gmail, Google Search Console, Linear, Notion, Attio, Meta Ads |
| **Form**  | Prompts for API keys or account credentials in the terminal | Datadog, PostHog, Snowflake, LaunchDarkly, WorkOS, Apollo, Higgsfield        |
...
| `Skills.metaAds()`   | `adAccount`, `pageId` | Restricts this automation to one ad account and Page |
| `Skills.higgsfield()` | None             | Generate ad creative images from a text prompt     |
