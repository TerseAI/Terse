...
| Type      | Flow                                                        | Examples                                            |
| --------- | ----------------------------------------------------------- | --------------------------------------------------- |
| **OAuth** | Opens your browser for authorization                        | GitHub, Slack, Gmail, Linear, Notion, Attio, Meta Ads |
...
| `Skills.metaAds()`   | `adAccount`   | Optionally scopes to a default ad account              |
