...
| **In-app** | Pending approvals appear on the **Notifications** page. The sidebar shows a badge when anything is waiting. Filter the list (all, pending, in progress, completed) and approve or reject from each row, or open the run for full context. |
