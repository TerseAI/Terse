...
1. **Notification destination** is configured. Add a Slack workspace or confirm your email on **Notifications** under the **Destination** tab (in **Notification Defaults**).
