...
In Slack, only the person who clicks **Approve** or **Reject** can act on the request. Terse checks that their linked Slack account belongs to the same organization as the paused workflow. Other people in the channel — including Slack guests, channel members who are not in your Terse org, or members of a different Terse org in a shared workspace — cannot approve on someone else's behalf. The audit trail records the clicker, not the notification destination.
