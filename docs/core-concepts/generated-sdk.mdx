...
export const Skills = {
    ...
    attio(opts: { object: AttioObject<any> }): TypedSkill<"attio_records" | "attio_workspace_members" | "attio_tasks" | "attio_notes" | "attio_comments" | "attio_lists" | "attio_meetings" | "attio_files" | "attio_schema"> {
        /* … */
    }
}
```
