...
<Steps>
    ...
    <Step title="Set the required environment variables">
        ...
        | Variable               | Purpose                                                                                                                  |
        | ---------------------- | ------------------------------------------------------------------------------------------------------------------------ |
        | `TERSE_API_KEY`        | Authenticates outbound calls from your handler to Terse: opening a session, executing tools, requesting approvals. Must be a current API token for an active user in that organization; revoked or stale tokens return **401**.       |
