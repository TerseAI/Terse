...
| `TERSE_VERSION` | Image tag to run. Pinned to the release you scaffolded with; set to `latest` to track the newest release. |
| `TERSE_IMAGE` | Point at a mirror of the Terse image. Commented out by default. |
