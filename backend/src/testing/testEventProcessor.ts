...
const mockEmails = {
  ...
  "recruiter-call": {
    ...
    snippet:
      "Great news! We've reviewed your application and we're very impressed with your background...",
  },
  "technical-interview": {
    id: "msg_003",
    threadId: "thread_001",
    ...
    snippet:
      "It was great speaking with you yesterday! I'm excited to move you forward to the technical interview...",
  },
  "final-round": {
    id: "msg_004",
    threadId: "thread_001",
    ...
    snippet:
      "Fantastic job on the technical interview! Alex was really impressed with your problem-solving approach...",
  },
  "offer-received": {
    id: "msg_005",
    threadId: "thread_001",
    ...
    snippet:
      "I'm thrilled to share that we'd like to extend you an offer for the Senior Software Engineer position...",
  },
};
