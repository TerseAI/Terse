...
export class FigmaIntegrationManager implements Integration<FigmaIntegration, FigmaWebhookEvent> {
    ...
    async setupIntegration(integrationId: string, automationInput: AutomationInputWithConfigs): Promise<void> {
    ...
    async teardownIntegration(integrationId: string, automationInput: AutomationInputWithConfigs): Promise<void> {
        const teamId = automationInput.figma_config?.team_id;
