import { GenerateSurveyPromptRequest, SKIP_OPTION, SurveyConfigContext, SurveyQuestion } from "../../shared/PromptBuilderTypes"

export function formatConfigContext(inputConfigs?: SurveyConfigContext[], outputConfigs?: SurveyConfigContext[], knowledgeBaseConfigs?: SurveyConfigContext[]): string {
    let context = ""
...
export function formatSurveyAnswers(questions: SurveyQuestion[], answers: GenerateSurveyPromptRequest["answers"], writeInAnswers?: GenerateSurveyPromptRequest["writeInAnswers"]): string {
