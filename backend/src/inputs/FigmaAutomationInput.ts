...
/**
 * Manages setup and teardown for Figma automation inputs.
 * Handles creating and deleting Figma webhooks when automations are created/deleted.
 */
export class FigmaAutomationInputManager implements AutomationInputManager {
