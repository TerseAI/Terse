...
export class ConfluenceOutput extends Output<ConfluenceConfig> {
    constructor() {
        const toolbox: ToolboxEntry[] = [
            { tool: confluenceQueryPageTool as Tool, isReadOnly: true, integration: IntegrationType.ATLASSIAN, displayName: 'Query page' },
            { tool: confluenceAddCommentTool as Tool, isReadOnly: false, integration: IntegrationType.ATLASSIAN, displayName: 'Add comment' },
        ];
...
To find the correct position, first call confluence_query_page to see the page content, then identify the text range you want to comment on.`,
    ...
    needsApproval: (context) => needsApproval(context, ToolName.CONFLUENCE_ADD_COMMENT),
