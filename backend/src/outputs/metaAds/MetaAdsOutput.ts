...
export class MetaAdsOutput extends Output<MetaAdsOutputConfig> {
    ...
    protected getSystemInstructionsForConfigs(configs: MetaAdsOutputConfig[]): string {
        ...
        sections.push("Use meta_ads_read_insights for spend, impressions, clicks, and conversions (the 'actions' array) over a datePreset or since/until range.")
        ...
        sections.push("Use meta_ads_send_conversions to push offline conversions to a Conversions API dataset (pixel) ID.")
