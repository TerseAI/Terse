...
import { SlackAttachment, SlackBlock, SlackBlocks, SlackEventData, SlackFile, SlackFiles } from "terse-types"
 ...
 */
export function extractImagesFromMessage(event: SlackEventData): SlackMessageImage[] {
