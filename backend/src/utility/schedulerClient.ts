  ...
  constructor() {
    try {
      ...
      if (!serviceAccountBase64) {
        throw new Error(
          'GCP_SERVICE_ACCOUNT_BASE64 environment variable is required to initialize Scheduler client'
        );
      }
      ...
      if (!projectId) {
        throw new Error(
          'GCP_PROJECT_ID environment variable is required to initialize Scheduler client'
        );
      }
