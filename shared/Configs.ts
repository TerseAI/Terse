...
export type ConfigInstanceImplementation = GmailConfig | FigmaConfig | SlackConfig | SlackOutputConfig | GmailOutputConfig | NotionPageConfig | NotionConfig | LinearInputConfig | LinearOutputConfig | GitHubConfig | GitHubKBConfig | JiraConfig | ConfluenceConfig | PosthogConfig | DatadogConfig | TimeTriggerConfig | LaunchDarklyConfig;
